...
BAC-PB = Instrument('BAC-PB', 2, 'Bank of America Corp')
BAC-PC = Instrument('BAC-PC', 2, 'Bank of America Corp')
BAC-PE = Instrument('BAC-PE', 2, 'Bank of America Corp')
BAC-PL = Instrument('BAC-PL', 2, 'Bank of America Corp')
BAC-PM = Instrument('BAC-PM', 2, 'Bank of America Corp')
BAC-PN = Instrument('BAC-PN', 2, 'Bank of America Corp')
BBL = Instrument('BBL', 2, 'BHP Group')
BHP = Instrument('BHP', 2, 'BHP Group PLC')
BHPLF = Instrument('BHPLF', 2, 'BHP Group Ltd')
BML-PG = Instrument('BML-PG', 2, 'Bank of America Corp')
BML-PH = Instrument('BML-PH', 2, 'Bank of America Corp')
BML-PJ = Instrument('BML-PJ', 2, 'Bank of America Corp')
BML-PL = Instrument('BML-PL', 2, 'Bank of America Corp')
BMY = Instrument('BMY', 2, 'Bristol-Myers Squibb Co')
BRK-A = Instrument('BRK-A', 2, 'Berkshire Hathaway Inc. Class A')
BRK-B = Instrument('BRK-B', 2, 'Berkshire Hathaway Inc. Class B')
BUD = Instrument('BUD', 2, 'Anheuser Busch Inbev NV')
C = Instrument('C', 2, 'Citigroup Inc.')
C-PJ = Instrument('C-PJ', 2, 'Citigroup Inc.')
C-PK = Instrument('C-PK', 2, 'Citigroup Inc.')
CCI-PA = Instrument('CCI-PA', 2, 'Crown Castle International Corp')
...
DHR-PA = Instrument('DHR-PA', 2, 'Danaher Corporation')
...
JPM-PC = Instrument('JPM-PC', 2, 'JPMorgan Chase & Co.')
JPM-PD = Instrument('JPM-PD', 2, 'JPMorgan Chase & Co.')
JPM-PG = Instrument('JPM-PG', 2, 'JPMorgan Chase & Co.')
JPM-PH = Instrument('JPM-PH', 2, 'JPMorgan Chase & Co.')
JPM-PJ = Instrument('JPM-PJ', 2, 'JPMorgan Chase & Co.')
...
NEE-PK = Instrument('NEE-PK', 2, 'NextEra Energy Inc')
NEE-PP = Instrument('NEE-PP', 2, 'NextEra Energy Inc')
...
RDS-A = Instrument('RDS-A', 2, 'Royal Dutch Shell plc ADR Class A')
RDS-B = Instrument('RDS-B', 2, 'Royal Dutch Shell plc ADR Class B')
